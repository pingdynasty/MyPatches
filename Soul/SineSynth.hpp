...
public:
    ...
    std::vector<EndpointDetails> getInputEndpoints() const
    {
        return
        {
            { "volume", "in:volume", EndpointType::event, "float32",                     0, "{ \"name\": \"Volume\", \"min\": -40, \"max\": 0, \"init\": -6, \"step\": 1, \"label\": \"Volume\", \"unit\": \"dB\" }" },
    ...
    void soul__voice_allocators__Basic___for__root__SineSynth_voiceAllocator___eventIn_struct_PitchBend (soul__voice_allocators__Basic___for__root__SineSynth_voiceAllocator___State& _state, soul__note_events__PitchBend e) noexcept
    {
        ...
        _if_0: { soul__voice_allocators__Basic___for__root__SineSynth_voiceAllocator___voiceEventOut_struct_PitchBend (_state, static_cast<int32_t> (voice) & 7, e); }
        _ifnot_0: { _2 = voice;
                    voice = (_2 + 1) & 7;
                    counter_0 = counter_0 - 1;
                    goto _loop_0;
