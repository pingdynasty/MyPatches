...
public:  
  ...
  void updatePhaseIncrements(){
    ...
    for(int n=0; n<numberOfOscillators; n++){
      ...
      //phaseIncrements[n]=frequencyRatios[n]*frequency * 2;// the *2 multiplier takes into account that the oscillator range is -1 to 1
    }
  }
  ...
  */ 
  ...
  void setFrequency(float aFrequency){
    ...
    filter->setHighPass(frequency, FilterStage::BUTTERWORTH_Q);
  }
  */
  void setFrequency(float aFrequency){ 
